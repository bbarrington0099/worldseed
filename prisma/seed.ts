...
async function main() {
    console.log("🧹 Deleting all existing official data...");
    ...
    console.log("  1. Run 'npm run docker:dev:build' to start the development environment");
    console.log("  2. Login with admin@alabastria.local / admin123");
